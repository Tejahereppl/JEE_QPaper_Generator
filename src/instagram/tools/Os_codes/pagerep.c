...
int pageFaultsMFU(int pages[], int n, int frames);
int pageFaultsMRU(int pages[], int n, int frames);
int pageFaultsLFU(int pages[], int n, int frames);
...
int main()
{
    ...
    printf("Number of Page Faults for MFU: %d\n", pageFaultsMFU(pages, n, frames));
    printf("Number of Page Faults for MRU: %d\n", pageFaultsMRU(pages, n, frames));
    printf("Number of Page Faults for LFU: %d\n", pageFaultsLFU(pages, n, frames));
...
int pageFaultsMFU(int pages[], int n, int frames)
{
    int frame[frames], count[n], pageFaults = 0, frameCount = 0;
...
int pageFaultsLFU(int pages[], int n, int frames)
{
    int frame[frames], count[frames], pageFaults = 0, frameCount = 0;
